...
const createProject = async (req, res) => {
    try {
        ...
        res.status(201).json({ message: "Successfully created the project.", data: result.rows });
...
const deleteProjects = async (req, res) => {
    try {
        ...
        res.status(200).json({message: "Successfully deleted the project.", data: result.rows});
    } catch (err) {
